...
class ProductListController extends Controller
{
    ...
    public function getBrandProductsView(Request $request, $slug)
    {
        ...
        return self::getProductsListPage(
            request: $request,
            pageType: $dataForm,
            pageTitle: ucwords(str_replace(['-', '_'], ' ', $brand['name'])) . ' Products | ' . getWebConfig('company_name') . ' Uganda',
            metaData: $brand?->seo
        );
    }
    ...
    public function getCategoryProductsView(Request $request, $slug)
    {
        ...
        return self::getProductsListPage(
            request: $request,
            pageType: $dataForm,
            pageTitle: ucwords(str_replace(['-', '_'], ' ', $category['name'])) . ' | ' . getWebConfig('company_name') . ' Uganda',
