...
class HomeController extends Controller
{
    ...
    public function default_theme(): View
    {
        ...
        $latestProductsList = $this->cacheHomePageLatestProductList()->shuffle()->take(8);
        ...
        $dealOfTheDay = DealOfTheDay::with(['product' => function ($query) {
            ...
            ->first();
        // Trending Products
        $trendingProducts = $topRatedProducts->take(8);
    ...
    public function theme_aster(): View
    {
        ...
        // Trending Products - based on best sellers
        $trendingProducts = $bestSellProduct->take(8);
        return view(VIEW_FILE_NAMES['home'],
            compact(
                ...
                'categories', 'topVendorsListSectionShowingStatus', 'clearanceSaleProducts', 'recommendedProduct', 'trendingProducts'
            )
        );
    }
