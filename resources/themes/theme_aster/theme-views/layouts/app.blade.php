...
<head>
    ...
    {{-- SEO: Organization & LocalBusiness Schema (PRD Section 3.2.3) --}}
    <script type="application/ld+json">
    {
        "@@context": "https://schema.org",
        "@@type": ["Organization", "LocalBusiness"],
        "name": "{{ $web_config['company_name'] ?? 'Yoola' }}",
        "alternateName": "Yoola Uganda",
        "url": "{{ url('/') }}",
        "logo": "{{ $web_config['fav_icon']['path'] ?? '' }}",
        "description": "Uganda's trusted electronics marketplace. Buy TVs, fridges, laptops & home appliances from verified sellers with free Kampala delivery and Mobile Money payment.",
        "address": {
            "@@type": "PostalAddress",
            "streetAddress": "Burton St, Aponye City Mall",
        ...
        "telephone": "+256200942214",
        "email": "{{ getWebConfig('company_email') ?? 'support@yoola.ug' }}",
        "sameAs": [
            "https://facebook.com/people/Yoola-UG/61567250315925",
            "https://twitter.com/Yoola_UG",
            "https://instagram.com/yoola_ug",
            "https://youtube.com/@yoola_ug"
        ],
        "priceRange": "UGX 50,000 - UGX 10,000,000",
...
{{-- Exit Intent Popup --}}
@include('theme-views.partials._exit-popup')

    @include('theme-views.partials._floating-whatsapp')
</body>
</html>
