...
@section('title', translate('Personal_Details').' | '.$web_config['company_name'].' 'Uganda')
@section('content')
                                                        ...
                                                        @if($customerDetail['is_phone_verified'])
                                                            <span class="position-absolute inset-inline-end-10px cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ translate('Your_phone_is_verified') }}">
                                                                <img width="16"
                                                                     ...
                                                                     class="dark-support" alt="{{ $product['name'] ?? 'Product' }}">
                                                            </span>
                                                        @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex flex-column gap-3">
                                                    <div class="upload-file">
                                                        <input type="file" class="upload-file__input --size-8-75rem"  name="image" multiple aria-required="true" accept="{{getFileUploadFormats(skip: '.svg,.gif')}}"  data-max-size="{{ getFileUploadMaxSize() }}">
                                                        <div class="upload-file__img">
                                                            ...
                                                            <img src="#" class="dark-support img-fit-contain border" alt="{{ $product['name'] ?? 'Product' }}" hidden="">
                                                        </div>
                                                    </div>
