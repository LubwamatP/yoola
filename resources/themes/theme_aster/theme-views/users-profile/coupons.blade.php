...
@section('title', translate('coupons').' | '.$web_config['company_name'].' 'Uganda')
@section('content')
                                    ...
                                    @if(count($coupons) == 0)
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center gap-2 py-5 w-100">
                                                <img width="80" class="mb-3" src="{{ theme_asset('assets/img/empty-state/empty-coupon.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
