...
@section('title', translate('my_Loyalty_Point').' | '.$web_config['company_name'].' 'Uganda')
                                ...
                                <div class="wallet-card pb-3 rounded-10 ov-hidden mn-w loyalty-point-card"
                                    ...
                                    <div class="card-body d-flex flex-column gap-2 absolute-white">
                                        <img width="34" src="{{theme_asset('assets/img/icons/loyalty-point.png') }}"
                                             alt="{{ $product['name'] ?? 'Product' }}" class="dark-support">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                <input class="form-control" type="number" name="point" value="{{$totalLoyaltyPoint ?? 0}}" step="any" required>
                            </div>
                        </div>
                    </div>
