...
@section('title', translate('my_Order_List').' | '.$web_config['company_name'].' 'Uganda')
@push('css_or_js')
                                                        ...
                                                        <div class="media gap-3 align-items-center mn-w200">
                                                            <div
                                                                ...
                                                                @if($order->seller_is == 'seller')
                                                                    <img class="img-fit dark-support rounded" alt="{{ $product['name'] ?? 'Product' }}"
                                ...
                                @if($orders->count()==0)
                                    <div
                                        ...
                                        <img width="80" class="mb-3"
                                             src="{{ theme_asset('assets/img/empty-state/empty-order.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
                        ...
                        <div class="text-center pb-3 pt-4 mt-xl-2">
                            <div class="mb-20">
                                <img width="56" height="56" class=""
                                     src="{{theme_asset(path: "/assets/img/icons/check-fill.png")}}" alt="{{ $product['name'] ?? 'Product' }}">
                            </div>
