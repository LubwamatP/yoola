                            ...
                            <div class="position-relative">
                                @if(isset($chattingMessages) && count($chattingMessages) > 0)
                                    ...
                                    <div
                                        ...
                                        <div class="alert-box">
                                            <div><img src="{{ theme_asset('assets/img/icons/warning.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
                                            </div>
                                            <div>
                                                {{ translate('sorry') }} !
                                ...
                                @else
                                    <div
                                        ...
                                        <img width="80" class="mb-3"
                                             src="{{ theme_asset('assets/img/empty-state/empty-message.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
