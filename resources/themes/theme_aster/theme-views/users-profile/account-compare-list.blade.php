...
@section('title', translate('my_Compare_List').' | '.$web_config['company_name'].' 'Uganda')
                            ...
                            <div class="h-100">
                                                    ...
                                                    @foreach ($compareLists as $compareList)
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-column gap-1 align-items-center">
                                                                ...
                                                                <img width="120" class="dark-support aspect-1 object-fit-cover rounded" alt="{{ $product['name'] ?? 'Product' }}"
                                                            ...
                                                            @if(isset($compareList->product->brand->image))
                                                                <td>
                                                                    <a href="{{ route('brand-products', ['slug' => $compareList->product->brand['slug']]) }}">
                                                                        <img width="48" class="rounded dark-support" alt="{{ $product['name'] ?? 'Product' }}"
                                ...
                                @if($compareLists->count()==0)
                                    <div class="d-flex flex-column justify-content-center align-items-center gap-2 py-3 w-100 bg-light rounded h-100">
                                        <img width="80" class="mb-3 svg" src="{{ theme_asset('assets/img/empty-state/empty-compare-list.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
