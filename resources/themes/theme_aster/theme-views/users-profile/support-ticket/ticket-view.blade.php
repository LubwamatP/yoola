...
@section('title', translate('Support_Ticket').' | '.$web_config['company_name'].' 'Uganda')
                        ...
                        <div
                            ...
                            <div class="media flex-wrap gap-3">
                                <div class="avatar avatar-lg rounded-circle">
                                    <img loading="lazy" class="img-fit rounded-circle dark-support aspect-1 max-w-140px" alt="{{ $product['name'] ?? 'Product' }}"
                                                ...
                                                <div class="d-flex flex-wrap g-2 gap-2 justify-content-end custom-image-popup-init">
                                                    @foreach ($conversation->attachment_full_url as $key => $photo)
                                                        <a class="inbox-image-element custom-image-popup" href="{{ getStorageImages(path: $photo, type:'product') }}">
                                                            <img src="{{ getStorageImages(path: $photo, type:'product') }}" alt="{{ $product['name'] ?? 'Product' }}">
                                                        </a>
                                                    @endforeach
                                                </div>
                                            @endif
