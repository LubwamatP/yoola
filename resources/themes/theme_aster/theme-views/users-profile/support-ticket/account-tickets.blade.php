...
@section('title', translate('My_Support_Tickets').' | '.$web_config['company_name'].' 'Uganda')
@section('content')
                                ...
                                <div class="bg-light rounded-10">
                                    <div class="border-bottom support-ticket-row border-grey p-3">
                                        <div class="media gap-2 gap-sm-3">
                                            <div class="avatar">
                                                <img loading="lazy" class="img-fit dark-support" alt="{{ $product['name'] ?? 'Product' }}"
                            ...
                            @if($supportTickets->count()==0)
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center gap-2 py-5 w-100">
                                        <img width="80" class="mb-3" src="{{ theme_asset('assets/img/empty-state/empty-ticket.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
