...
@section('title', translate('Restock_Requests').' | '.$web_config['company_name'].' 'Uganda')
@section('content')
                                                ...
                                                <td>
                                                    <div class="media gap-3 align-items-center mn-w200">
                                                        <div class="avatar rounded size-3-75rem aspect-1 overflow-hidden d-flex align-items-center">
                                                            <img class="img-fit dark-support rounded" alt="{{ $product['name'] ?? 'Product' }}" src="{{ getStorageImages(path: $restockProduct?->product?->thumbnail_full_url, type: 'backend-product') }}">
                                                        </div>
                            ...
                            <div class="d-flex d-md-none gap-3 flex-column">
                                <div class="media gap-3 bg-light p-3 rounded">
                                    <div class="avatar border rounded size-3-437rem">
                                        <img src="{{ getStorageImages(path: $restockProduct?->product->thumbnail_full_url, type: 'backend-product') }}" class="img-fit dark-support rounded" alt="{{ $product['name'] ?? 'Product' }}">
                                    </div>
