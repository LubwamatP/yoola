                                        ...
                                        <div class="bg-light my-2 rounded-10 p-4">
                                            <div class="d-flex align-items-center justify-content-between gap-3">
                                                @foreach($order['details']->take(3) as $key=>$detail)
                                                    <div>
                                                        <img width="42" alt="{{ $product['name'] ?? 'Product' }}" class="dark-support rounded" loading="lazy"
                                                                ...
                                                                class="d-flex flex-column gap-2 mb-3 align-items-center">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img alt="{{ $product['name'] ?? 'Product' }}" loading="lazy" class="dark-support img-fit"
                                        ...
                                        <div class="d-flex flex-column gap-2 p-3">
                                            <h5 class="d-flex gap-2 align-items-center">
                                                @if($coupon->coupon_type == 'free_delivery')
                                                    ...
                                                    <img src="{{ theme_asset('assets/img/svg/delivery-car.svg') }}" alt="{{ $product['name'] ?? 'Product' }}"
                                                        class="svg">
                                                @else
