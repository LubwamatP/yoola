            ...
            <div class="modal-body">
                <div>
                    ...
                    @elseif($previewFileInfo['mime_category'] == 'image')
                        <div>
                            <img loading="lazy" class="w-100" src="{{ $product->preview_file_full_url['path'] }}" alt="{{ $product['name'] ?? 'Product' }}">
                        </div>
                    ...
                    @else
                        <div class="d-flex flex-column gap-2 align-items-center py-4">
                            <img src="{{ theme_asset(path: 'assets/img/icons/export.svg') }}" alt="{{ $product['name'] ?? 'Product' }}" width="50">
