...
@section('title', translate('all_Brands_Page').' | '.$web_config['company_name'].' Uganda')
                ...
                <div class="card-body">
                    ...
                    @if($brands->count()==0)
                        <div class="d-flex flex-column justify-content-center align-items-center gap-2 py-3 w-100">
                            <img width="80" class="mb-3" src="{{ theme_asset('assets/img/empty-state/empty-brand.svg') }}" alt="{{ $product['name'] ?? 'Product' }}">
