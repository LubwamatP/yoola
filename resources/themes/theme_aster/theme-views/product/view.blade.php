...
@section('title', isset($robotsMetaContentData) && $robotsMetaContentData?->title ? $robotsMetaContentData->title : $pageTitleContent)

@push('css_or_js')
    <meta property="og:image" content="{{$web_config['web_logo']['path']}}"/>
    <meta property="og:title" content="{{ isset($robotsMetaContentData) && $robotsMetaContentData?->title ? $robotsMetaContentData->title : $pageTitleContent }} | {{ $web_config['company_name'] }}"/>
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:description" content="{{ isset($robotsMetaContentData) && $robotsMetaContentData?->meta_description ? $robotsMetaContentData->meta_description : (isset($pageTitleContent) ? 'Browse ' . $pageTitleContent . ' at the best price in Uganda. Free delivery Kampala.' : $web_config['meta_description']) }}">
    <meta property="twitter:card" content="summary_large_image"/>
    <meta property="twitter:title" content="{{ isset($robotsMetaContentData) && $robotsMetaContentData?->title ? $robotsMetaContentData->title : $pageTitleContent }} | {{ $web_config['company_name'] }}"/>
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:description" content="{{ isset($robotsMetaContentData) && $robotsMetaContentData?->meta_description ? $robotsMetaContentData->meta_description : (isset($pageTitleContent) ? 'Browse ' . $pageTitleContent . ' at the best price in Uganda. Free delivery Kampala.' : $web_config['meta_description']) }}">
@endpush
