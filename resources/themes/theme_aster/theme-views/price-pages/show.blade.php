...
<main class="main-content">
    ...
    <section class="price-hero">
        <div class="container">
            ...
            <a href="https://wa.me/256704229768?text={{ urlencode('Hi! I\'m interested in ' . $pricePage->h1 . '. What\'s available?') }}" 
    ...
    <div class="container py-4">
        ...
        @else
            <div class="alert alert-info">
                ...
                <a href="https://wa.me/256704229768" class="alert-link">WhatsApp us</a> for current availability.
            </div>
        @endif
    </div>
    ...
    <div class="container py-5">
        <div class="text-center p-5 bg-light rounded">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <a href="https://wa.me/256704229768" class="btn btn-success btn-lg">
                    <i class="bi bi-whatsapp"></i> WhatsApp: +256704229768
                </a>
    ...
    <div class="sticky-cta d-md-none">
        <a href="https://wa.me/256704229768" class="whatsapp-cta">
