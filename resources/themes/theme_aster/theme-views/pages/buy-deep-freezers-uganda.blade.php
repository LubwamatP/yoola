...
@section('title', 'Buy Deep Freezers in Uganda | Chest Freezers | Yoola')
@push('css_or_js')
<meta name="description" content="Buy genuine deep freezers & chest freezers in Uganda. Perfect for business or home storage. Free delivery Kampala & Wakiso.">
<link rel="canonical" href="https://yoola.ug/buy/deep-freezers-uganda">
@endpush
@section('content')
<nav class="bg-light py-2"><div class="container"><ol class="breadcrumb mb-0 small"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item active">Deep Freezers</li></ol></div></nav>
<div class="bg-primary text-white py-4"><div class="container"><h1 class="fw-bold text-white mb-2">Buy Deep Freezers in Uganda</h1><p class="text-white-50 mb-0">{{ $products->count() }} Freezers - Ideal for business & bulk storage</p></div></div>
...
<h2 class="h5 mb-3">All Deep Freezers</h2>
...
@empty<p class="text-muted">No deep freezers available.</p>@endforelse
</div>
