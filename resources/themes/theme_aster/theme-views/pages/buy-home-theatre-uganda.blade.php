...
@section('title', 'Buy Home Theatre System Uganda | Sony, LG, JBL | Yoola')
@section('meta')
<meta name="description" content="Buy home theatre systems in Uganda. 5.1 surround sound, Bluetooth speakers. Sony, LG, JBL. Free delivery Kampala.">
<link rel="canonical" href="https://yoola.ug/buy/home-theatre-uganda">
@endsection
@section('content')
<div class="container py-4">
    <nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb small"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item active">Home Theatre</li></ol></nav>
    <div class="text-center mb-4">
        <h1 class="fw-bold" style="color: var(--bs-primary);">Buy Home Theatre System in Uganda</h1>
        <p class="text-muted">Cinema experience in your living room</p>
    ...
    <h2 class="h5 mb-3">Home Theatre Systems</h2>
    <div class="row g-3 mb-5">
        ...
        @empty
        <div class="col-12"><div class="alert alert-info">No home theatre systems available. <a href="https://wa.me/256704229768">Contact us</a>.</div></div>
        @endforelse
    </div>
    <div class="text-center py-4"><a href="https://wa.me/256704229768?text=Home%20Theatre" class="btn btn-lg" style="background:#25D366;color:white"><i class="bi bi-whatsapp me-2"></i> Order on WhatsApp</a></div>
</div>
@endsection
