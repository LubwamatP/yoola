...
@section('title', 'Buy Water Dispensers in Uganda | Hot & Cold | Yoola')
@push('css_or_js')
<meta name="description" content="Buy water dispensers in Uganda. Hot & cold water dispensers for home and office. Free delivery Kampala.">
<link rel="canonical" href="https://yoola.ug/buy/water-dispensers-uganda">
@endpush
@section('content')
<nav class="bg-light py-2"><div class="container"><ol class="breadcrumb mb-0 small"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item active">Water Dispensers</li></ol></div></nav>
<div class="bg-primary text-white py-4"><div class="container"><h1 class="fw-bold text-white mb-2">Buy Water Dispensers in Uganda</h1><p class="text-white-50 mb-0">{{ $products->count() }} Dispensers - Hot & cold water</p></div></div>
...
<h2 class="h5 mb-3">All Water Dispensers</h2>
...
@empty<p class="text-muted">No water dispensers available.</p>@endforelse
</div>
