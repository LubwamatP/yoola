...
@section('title', 'Buy Gas Cooker in Uganda | 2, 4, 6 Burner | Yoola')
@section('meta')
<meta name="description" content="Buy gas cookers in Uganda. 2, 4, 6 burner cookers with oven. Free standing and table top. Free delivery Kampala.">
<link rel="canonical" href="https://yoola.ug/buy/gas-cooker-uganda">
@endsection
@section('content')
<div class="container py-4">
    <nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb small"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item active">Gas Cookers</li></ol></nav>
    <div class="text-center mb-4">
        <h1 class="fw-bold" style="color: var(--bs-primary);">Buy Gas Cooker in Uganda</h1>
        <p class="text-muted">2, 4, 6 burner cookers with oven</p>
    ...
    <h2 class="h5 mb-3">Gas Cookers</h2>
    <div class="row g-3 mb-5">
        ...
        @empty
        <div class="col-12"><div class="alert alert-info">No gas cookers available. <a href="https://wa.me/256704229768">Contact us</a>.</div></div>
        @endforelse
    </div>
    <div class="text-center py-4"><a href="https://wa.me/256704229768?text=Gas%20Cooker" class="btn btn-lg" style="background:#25D366;color:white"><i class="bi bi-whatsapp me-2"></i> Order on WhatsApp</a></div>
</div>
@endsection
