...
@section('title', 'Samsung Refrigerators Uganda | Yoola.ug')

@section('content')
<div class="bg-primary text-white py-4">
    <div class="container">
        <h1>Samsung Refrigerators</h1>
        <p>Genuine Samsung fridges with 2-year warranty</p>
    </div>
</div>
...
<div class="container py-4">
    <div class="row g-3">
        ...
        <div class="col-12 text-center py-5">
            <p>No Samsung refrigerators in stock</p>
