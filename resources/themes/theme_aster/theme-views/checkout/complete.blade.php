...
@section('title', translate('order_Complete').' | '.$web_config['company_name'].' 'Uganda')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-md-10">
                            <div class="text-center d-flex flex-column align-items-center gap-3">
                                <img width="46" src="{{ theme_asset('assets/img/icons/check.png') }}" class="dark-support" alt="{{ $product['name'] ?? 'Product' }}">
