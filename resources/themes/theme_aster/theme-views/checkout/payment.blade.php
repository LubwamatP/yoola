...
@section('title', translate('Payment_Details') . ' | ' . $web_config['company_name'] . ' ' . 'Uganda')
                            ...
                            @if (!$activeMinimumMethods)
                                <div class="d-flex justify-content-center py-5 align-items-center">
                                    <div class="text-center">
                                        <img src="{{ theme_asset(path: 'assets/img/not_found.png') }}" alt="{{ $product['name'] ?? 'Product' }}"
                                             class="mb-4" width="70">
                                                    ...
                                                    <label class="w-100">
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="d-flex align-items-center gap-3 pt-1">
                                                                <img width="30" class="dark-support" alt="{{ $product['name'] ?? 'Product' }}"
