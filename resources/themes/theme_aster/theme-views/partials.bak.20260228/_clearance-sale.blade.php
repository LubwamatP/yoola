    ...
    <section class="flash-deal-dark-support">
        <div class="container px-0 px-sm-12">
            <div class="position-relative z-1">
                <img src="{{ theme_asset('assets/img/clearance-sale-background.svg') }}" class="clearance-sale-bg-svg svg position-absolute w-100 h-100 z-n1 start-0" alt="{{ $product['name'] ?? 'Product' }}">
