    ...
    <div class="aside-body search-aside-attribute-container py-4 pt-0">
        ...
        <ul class="aside-nav navbar-nav gap-2">
            ...
            @if(Helpers::module_permission_check('themes_and_addons'))
                ...
                {{-- AI Operations Dashboard - Hidden when AI module disabled --}}
                @if(getCheckAddonPublishedStatus(moduleName: 'AI'))
                <li class="nav-item nav-item_title {{ Request::is('admin/ai-operations*') ? 'scroll-here' : '' }}">
                    <small class="nav-subtitle" title="">{{ translate('AI_Operations') }}</small>
                </li>
                <li class="{{ Request::is('admin/ai-operations*') ? 'sub-menu-opened' : '' }}">
                    <a class="nav-link nav-link-toggle {{ Request::is('admin/ai-operations*') ? 'active' : '' }}"
                       href="javascript:" title="{{ translate('AI_Operations') }}">
                        <i class="fi fi-sr-brain-circuit"></i>
                        <span class="aside-mini-hidden-element flex-grow-1 d-flex justify-content-between align-items-center">
                            <span class="text-truncate max-w-180">{{ translate('AI_Operations') }}</span>
                            <i class="fi fi-sr-angle-down"></i>
                        </span>
                    </a>
                    <ul class="aside-submenu navbar-nav">
                        <li class="nav-item px-3 py-2 fw-semibold text-dark bg-section2 aside-mini-show-element">{{ translate('AI_Operations') }}</li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/ai-operations') ? 'active' : '' }}"
                               href="{{ route('admin.ai-operations.dashboard') }}" title="{{ translate('Dashboard') }}">
                                <span class="text-truncate">{{ translate('Dashboard') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/ai-operations/conversations*') ? 'active' : '' }}"
                               href="{{ route('admin.ai-operations.conversations') }}" title="{{ translate('AI_Chat') }}">
                                <span class="text-truncate">{{ translate('AI_Chat') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/ai-operations/notifications*') ? 'active' : '' }}"
                               href="{{ route('admin.ai-operations.notifications') }}" title="{{ translate('Smart_Notifications') }}">
                                <span class="text-truncate">{{ translate('Smart_Notifications') }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('admin/ai-operations/leads*') ? 'active' : '' }}"
                               href="{{ route('admin.ai-operations.leads') }}" title="{{ translate('Power_Calculator_Leads') }}">
                                <span class="text-truncate">{{ translate('Power_Calculator_Leads') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/analytics*') ? 'active' : '' }}"
                       href="{{ route('admin.analytics.index') }}" title="{{ translate('Live_Analytics') }}">
                        <i class="fi fi-sr-chart-line-up"></i>
                        <span class="aside-mini-hidden-element text-truncate flex-grow-1">
                            {{ translate('Live_Analytics') }}
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/power-calculator*') ? 'active' : '' }}"
                       href="{{ route('admin.power-calculator.settings') }}" title="{{ translate('Power_Calculator') }}">
                        <i class="fi fi-sr-calculator"></i>
                        <span class="aside-mini-hidden-element text-truncate flex-grow-1">
                            {{ translate('Power_Calculator') }}
                        </span>
                    </a>
                </li>
